...
export default function CadastrarAluno() {
    ...
    const [aluno, setAluno] = useState({
        ...
        aee: 'false', // Vamos tratar como string no select e converter para boolean no envio
        turno: 'Manhã',
        defasagem: 'false',
        beneficios: 'Nenhum'
    });
    ...
    const handleSalvar = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            escola: aluno.escola,
            // Ajuste vital para LocalDateTime: adicionando hora zerada
            dataNascimento: `${aluno.dataNascimento}T00:00:00`,
            cor: aluno.cor,
            escolaridade: aluno.escolaridade,
            aee: aluno.aee === 'true', // Converte string do select para Boolean
            turno: aluno.turno,
            defasagem: aluno.defasagem === 'true',
            beneficios: aluno.beneficios,

            // As relações @OneToMany exigem envio em formato de Lista (Array)
            enderecos: [
                {
                    rua: endereco.rua,
                    numero: Number(endereco.numero), // Converte para Long no Java
            ...
            historicoEvasao: [] // Inicia vazio no cadastro
        };

        try {
            await api.post('/alunos', payload);
            alert('Aluno matriculado com sucesso no sistema escolar!');
            // Reseta a tela para um novo cadastro
    ...
    return (
        <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-4xl mx-auto">
            ...
            <form onSubmit={passo === 3 ? handleSalvar : (e) => { e.preventDefault(); setPasso(passo + 1); }}>
                ...
                {/* ========================================== */}
                {/* PASSO 1: DADOS ACADÊMICOS E PESSOAIS */}
                {/* ========================================== */}
                {passo === 1 && (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    readOnly
                                    value={aluno.escola}
                                    className="w-full p-3 border border-slate-300 rounded bg-slate-200 text-slate-600 font-semibold outline-none cursor-not-allowed"
                                />
                            </div>
                            <div>
                ...
                {passo === 3 && (
                    <div className="space-y-5 animate-fadeIn">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {/* Telefones separados conforme sua Entidade */}
                            <div className="col-span-1">
                ...
                {/* BOTÕES FLUTUANTES NO RODAPÉ DO CARD */}
